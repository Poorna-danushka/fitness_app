...
const TYPE_COLORS = {
  info:    { dot: '#3b82f6', bg: 'rgba(59,130,246,0.12)',  text: '#60a5fa' },
  success: { dot: '#22c55e', bg: 'rgba(34,197,94,0.12)',   text: '#4ade80' },
  warning: { dot: '#eab308', bg: 'rgba(234,179,8,0.12)',   text: '#facc15' },
  urgent:  { dot: '#ef4444', bg: 'rgba(239,68,68,0.12)',   text: '#f87171' },
};
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:flex items-center gap-2.5 bg-white/[0.04] border border-white/[0.06] rounded-xl px-3.5 py-2 w-56 md:w-72 group focus-within:border-green-500/40 focus-within:bg-white/[0.06] transition-all duration-200">
          ...
          <input
            ...
            className="bg-transparent border-none outline-none text-sm text-white w-full placeholder:text-gray-600 font-inter"
          />
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <span
                            ...
                            style={{ background: colors.dot, opacity: isUnread ? 1 : 0.3 }}
                          />
        ...
        <div className="relative" ref={avatarRef}>
          ...
          {avatarOpen && (
            <div className="dropdown-panel absolute right-0 top-full mt-2 w-52 z-50 py-1.5">
              ...
              <div className="border-t border-white/[0.07] mt-1 pt-1 mx-1">
                <button
